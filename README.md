...
Intern Model
{ name: {mandatory}, email: {mandatory, valid email, unique}, mobile: {mandatory, valid mobile number, unique}, collegeId: {ef to college mObjectId, rodel, isDeleted: {boolean, default: false}}
